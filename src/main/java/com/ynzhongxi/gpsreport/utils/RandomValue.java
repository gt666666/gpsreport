...
public class RandomValue {
    ...
    private static String MOCKJS_URL = "https://cdn.bootcss.com/Mock.js/1.0.1-beta3/mock-min.js";
    ...
    public static Object mockRandom(String script) throws ScriptException {
        // 把mockjs读取到缓存
        if (lfuCache.isEmpty()) {
            String scriptString = HttpUtil.downloadString(MOCKJS_URL, CharsetUtil.CHARSET_UTF_8);
